...
namespace ProyectoDeGradoFundacion.Models
{
    ...
    public class Cita
    {
        ...
        // ============================
        // 🔥 CONTROL DE CARGA Y RESPONSABLE
        // ============================

        [Column("fecha_carga_ojo_izquierdo")]
        public DateTime? FechaCargaOjoIzquierdo { get; set; }

        [Column("fecha_carga_ojo_derecho")]
        public DateTime? FechaCargaOjoDerecho { get; set; }
